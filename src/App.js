      ...
      <div className="my-4">
        ...
        <div className="documentation">
          ...
          <div className="buttonClass text-center my-4">
            <button type="button" className="btn btn-primary" style={{ 'margin': 'auto' }}>{/* Put app link here */}<a href="./trademaster.apk" download="TradeMaster" style={{ 'color': 'white', "textDecoration": "none" }}>Download App</a></button>
          </div>
        </div>
        <div id="aboutUs">
